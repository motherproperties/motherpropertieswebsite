 ...
 * Updated for PRD §5 IA with prominent CTA
 */
          ...
          <div className="flex justify-between items-center h-20 md:h-24 transition-all duration-300">
            ...
            <Link href="/" className="flex items-center space-x-3 group">
              ...
              <div className="hidden sm:block">
                ...
                <div className="text-xs text-cream-100/80 font-medium tracking-wide">
            ...
            <div className="hidden md:flex items-center space-x-6">
                ...
                {siteConfig.navigation.map((item) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <span
                        className={`absolute bottom-0 left-0 w-full h-0.5 bg-gold-400 transform origin-left transition-transform duration-300 ${
                          isActive
                            ? 'scale-x-100'
              ...
              <Link
                href="/site-visit/"
                className="flex items-center gap-2 bg-gold-500 hover:bg-gold-400 text-forest-900 text-sm font-semibold px-4 py-2.5 rounded-xl transition-colors duration-300 shadow-md hover:shadow-lg"
              >
